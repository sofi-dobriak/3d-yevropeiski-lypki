...
export default function VillaExteriorCard(img, title, description, i18n, i) {
  return `
  <div class="s3d-villa__exterior-card">
    <div class="s3d-villa__exterior-card__img-wrap">
      <img src="${img}" alt="villa exterior image" loading="lazy">
    </div>
    <div class="s3d-villa__exterior-card__text-wrap">
      <div class="s3d-villa__exterior-card__text-wrap--top">
        <span class="s3d-villa__exterior-card__number">0${i + 1}.</span>
        <span class="s3d-villa__exterior-card__title">${title}</span>
        <span class="s3d-villa__exterior-card__line"></span>
      </div>
      <div class="s3d-villa__exterior-card__text-wrap--bottom">
        <span class="s3d-villa__exterior-card__text">${description}</span>
        <!--${ButtonIconLeft(
          'active',
          'data-open-form',
          i18n.t('Flat.exterior.exteriorContactButton'),
          'Phone',
          'secondary',
        )}-->
        <button class="ButtonIconLeft active ButtonIconLeft--secondary" data-open-form="">
          ...
          <span>${i18n.t('Flat.exterior.exteriorContactButton')}</span>
        </button>
      </div>
    </div>
  </div>
