...
export default function constructionPopup(data, i18n) {
  ...
  const paginationHtml = `
        <div class="construction-popup__counter">
          <span data-construction-popup-slider-counter>1</span> / <span data-construction-popup-slider-total>${data
            .gallery.length + data.videos.length || 1}</span>
        </div>
      `;
            ...
            <div class="construction-popup__content">
                ...
                <div class="construction-popup__slider swiper-container" data-construction-popup-slider>
                    <div class="construction-popup__nav">
                      ${s3d2_SwiperButtons({
                        className: 'construction-nav-buttons',
                        classNamePrev: 'construction-swiper-button-prev',
                        classNameNext: 'construction-swiper-button-next',
                        content: paginationHtml,
                        attrsPrev: {
                          'data-construction-popup-slider-prev': true,
                          'aria-label': 'prev',
                        },
                        attrsNext: {
                          'data-construction-popup-slider-next': true,
                          'aria-label': 'next',
                        },
                      })}
                      <!--<div class="s3d-flat-new__apartments-list-swiper-button-prev s3d-villa__construction-swiper-button-prev" data-construction-popup-slider-prev>
                        ...
                        <!--<div class="construction-popup__counter">
                        <span data-construction-popup-slider-counter>1</span><span>/</span><span data-construction-popup-slider-total>${data
                          .gallery.length + data.videos.length}</span></div>-->
                ...
                <div class="construction-popup__text">
                        ...
                        <div class="construction-card-label">
                            ...
                            ${
                              data.videos.length > 0
                                ? `<span> / ${data.videos.length} ВІДЕО</span>`
                                : ''
                            }
                        </div>
                        <div class="construction-card-date" data-construction-popup-date>${
                          data.date
                        }</div>
                    </div>
                    ...
                    <button class="s3d2-ButtonIconLeft s3d2-ButtonIconLeft--light" data-open-form="" data-construction-popup-close="data-construction-popup-close">
