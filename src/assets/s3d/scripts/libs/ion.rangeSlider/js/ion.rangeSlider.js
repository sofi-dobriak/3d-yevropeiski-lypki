...
(function (factory) {
	...
	const base_html = '<span class="irs">'
	...
	const single_html = '<span class="irs-bar irs-bar--single"></span>'
        + '<span class="irs-shadow shadow-single"></span>'
        + '<span class="irs-handle single"><i></i><i></i><i></i></span>'

	const double_html = '<span class="irs-bar"></span>'
	...
	const IonRangeSlider = function (input, options, plugin_count) {
		...
		let config; let config_from_data; let
			prop
